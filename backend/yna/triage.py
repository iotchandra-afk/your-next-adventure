...
def _eligible_roles(db: SupabaseREST, limit: int) -> list[dict[str, Any]]:
    # Start with explicit executive-plausible roles. Ambiguous-title roles remain safely retained
    # and will be swept by subsequent broad-mandate passes, never hard-rejected here.
